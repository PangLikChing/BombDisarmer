...
public class DivideCalculator : MonoBehaviour
{
        ...
        if (box1 != null && box2 != null)
        {
            if (itemSlot1.full == true && itemSlot2.full == true)
            {
                ...
                if (int.Parse(box1.GetComponentInChildren<Text>().text) >= int.Parse(box2.GetComponentInChildren<Text>().text) &&
                    int.Parse(box1.GetComponentInChildren<Text>().text) % int.Parse(box2.GetComponentInChildren<Text>().text) == 0)
                {
                ...
                else
                {
                    ...
                    box1.transform.position = new Vector3(305, 60, 0);
                    box2.transform.position = new Vector3(425, 60, 0);
